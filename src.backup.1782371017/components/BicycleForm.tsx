    ...
    <form action={action} className="grid grid-cols-1 gap-6 lg:grid-cols-3">
      <div className="space-y-4 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                min="1900"
                max="2100"
                defaultValue={bicycle?.year ?? undefined}
                placeholder="2023"
                className="input"
              />
            </div>
            ...
            <div>
              ...
              <input
                name="color"
                defaultValue={bicycle?.color ?? undefined}
            ...
            <div>
              ...
              <input
                name="serialNumber"
                defaultValue={bicycle?.serialNumber ?? undefined}
            ...
            <div>
              ...
              <input
                name="frameSize"
                defaultValue={bicycle?.frameSize ?? undefined}
                placeholder='M (18")'
                className="input"
              />
            </div>
            <div>
              ...
              <input
                name="wheelSize"
                defaultValue={bicycle?.wheelSize ?? undefined}
                placeholder='29"'
                className="input"
              />
            </div>
        ...
        <div className="card p-4 sm:p-6">
          ...
          <textarea
            name="notes"
            defaultValue={bicycle?.notes ?? undefined}
            rows={4}
