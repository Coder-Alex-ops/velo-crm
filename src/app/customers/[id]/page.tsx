...
export default async function EditCustomer({
  ...
  const customerBikes = db.bicycles.filter((b) => b.customerId === customer.id);
  const customerServices = db.serviceRecords
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <div className="flex shrink-0 flex-col items-end gap-1">
                            <span
                              className={clsx("badge", sm.bg, sm.text)}
                            >
                              {sm.label}
                            </span>
                            ...
                            <span
                              className={clsx("badge", pm.bg, pm.text)}
                            >
                              {pm.label}
                            </span>
                          </div>
